...
function service(ns) {
    return function (Clazz) {
        ...
        // 给外面用的原型实例
        var prototype = { setData: undefined, reset: undefined, onCreated: undefined, __origin: instance, onBeforeClean: undefined };
        // 是否正在同步标志位
        var isSyncing = false;
        ...
        Object.getOwnPropertyNames(Clazz.prototype).forEach(function (key) {
            ...
            if (key !== 'constructor' && typeof Clazz.prototype[key] === 'function') {
                ...
                prototype[key] = ((_a = allProto === null || allProto === void 0 ? void 0 : allProto[ns]) === null || _a === void 0 ? void 0 : _a[key]) || function () {
                    var params = [];
        ...
        prototype.setData = function (props) {
            var toBeAdd = Object.keys(props).filter(function (key) { return !Object.getOwnPropertyDescriptor(_toBeSyncState, key); });
            if (toBeAdd.length) { // 注册新属性
                toBeAdd.forEach(function (key) {
            ...
            if (Object.keys(props).some(function (key) { return props[key] !== _toBeSyncState[key]; })) { // 判断有没有修改
                // 重新实例化对象， 同步设置
                var newObj = Object.create(allProto[ns]);
