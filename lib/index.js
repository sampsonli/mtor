...
function getPropNames(proto, propNames) {
    if (propNames === void 0) { propNames = []; }
    if (!proto || proto === Model.prototype || proto === Object.prototype) {
        return propNames;
    }
    propNames = __spreadArrays(Object.getOwnPropertyNames(proto), propNames);
...
function service(ns) {
    return function (Clazz) {
        ...
        var propNames = getPropNames(Clazz.prototype);
