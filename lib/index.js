...
exports.useInitModel = exports.getModels = exports.Model = exports.resource = exports.inject = exports.useModel = exports.service = exports.enableHot = exports.define = void 0;
/**
 * mtor
...
function enableHot(hot) {
    if (hot.accept) {
        hot.accept(function (a) {
            service(a.default.ns)(a.default);
        });
    }
}
exports.enableHot = enableHot;
/**
 * 创建模块
