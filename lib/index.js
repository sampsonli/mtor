...
exports.useInitModel = exports.getModels = exports.convert = exports.Model = exports.resource = exports.inject = exports.useModel = exports.service = void 0;
/**
 * mtor
...
function service(ns) {
    return function (Clazz) {
        ...
        // 给外面用的原型实例
        var prototype = { setData: undefined, reset: undefined, created: undefined, eventBus: EventBus_1.eventBus, __origin: instance };
        // 给内部用的原型实例
 ...
 */
exports.useInitModel = function (Clazz, initFnName, clean) {
    if (initFnName === void 0) { initFnName = 'init'; }
